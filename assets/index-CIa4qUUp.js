 ...
 *
 * @license MIT
 */function wa(){return wa=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},wa.apply(this,arguments)}const tf=le.createContext(null),py=le.createContext(null),Cr=le.createContext(null),kl=le.createContext(null),br=le.createContext({outlet:null,matches:[],isDataRoute:!1}),Sv=le.createContext(null);function my(t,e){let{relative:n}=e===void 0?{}:e;Da()||_t(!1);let{basename:i,navigator:r}=le.useContext(Cr),{hash:s,pathname:a,search:o}=Mv(t,{relative:n}),c=a;return i!=="/"&&(c=a==="/"?i:Hi([i,a])),r.createHref({pathname:c,search:o,hash:s})}function Da(){return le.useContext(kl)!=null}function zl(){return Da()||_t(!1),le.useContext(kl).location}function Ev(t){le.useContext(Cr).static||le.useLayoutEffect(t)}function gy(){let{isDataRoute:t}=le.useContext(br);return t?Cy():vy()}function vy(){Da()||_t(!1);let t=le.useContext(tf),{basename:e,future:n,navigator:i}=le.useContext(Cr),{matches:r}=le.useContext(br),{pathname:s}=zl(),a=JSON.stringify(_v(r,n.v7_relativeSplatPath)),o=le.useRef(!1);return Ev(()=>{o.current=!0}),le.useCallback(function(u,f){if(f===void 0&&(f={}),!o.current)return;if(typeof u=="number"){i.go(u);return}let h=xv(u,JSON.parse(a),s,f.relative==="path");t==null&&e!=="/"&&(h.pathname=h.pathname==="/"?e:Hi([e,h.pathname])),(f.replace?i.replace:i.push)(h,f.state,f)},[e,i,a,s,t])}function Mv(t,e){let{relative:n}=e===void 0?{}:e,{future:i}=le.useContext(Cr),{matches:r}=le.useContext(br),{pathname:s}=zl(),a=JSON.stringify(_v(r,i.v7_relativeSplatPath));return le.useMemo(()=>xv(t,JSON.parse(a),s,n==="path"),[t,a,s,n])}function _y(t,e){return xy(t,e)}function xy(t,e,n,i){Da()||_t(!1);let{navigator:r}=le.useContext(Cr),{matches:s}=le.useContext(br),a=s[s.length-1],o=a?a.params:{};a&&a.pathname;let c=a?a.pathnameBase:"/";a&&a.route;let u=zl(),f;if(e){var h;let m=typeof e=="string"?Rr(e):e;c==="/"||(h=m.pathname)!=null&&h.startsWith(c)||_t(!1),f=m}else f=u;let p=f.pathname||"/",_=p;if(c!=="/"){let m=c.replace(/^\//,"").split("/");_="/"+p.replace(/^\//,"").split("/").slice(m.length).join("/")}let y=V0(t,{pathname:_}),x=Ty(y&&y.map(m=>Object.assign({},m,{params:Object.assign({},o,m.params),pathname:Hi([c,r.encodeLocation?r.encodeLocation(m.pathname).pathname:m.pathname]),pathnameBase:m.pathnameBase==="/"?c:Hi([c,r.encodeLocation?r.encodeLocation(m.pathnameBase).pathname:m.pathnameBase])})),s,n,i);return e&&x?le.createElement(kl.Provider,{value:{location:wa({pathname:"/",search:"",hash:"",state:null,key:"default"},f),navigationType:Pi.Pop}},x):x}function yy(){let t=Ry(),e=fy(t)?t.status+" "+t.statusText:t instanceof Error?t.message:JSON.stringify(t),n=t instanceof Error?t.stack:null,r={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return le.createElement(le.Fragment,null,le.createElement("h2",null,"Unexpected Application Error!"),le.createElement("h3",{style:{fontStyle:"italic"}},e),n?le.createElement("pre",{style:r},n):null,null)}const Sy=le.createElement(yy,null);class Ey extends le.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,n){return n.location!==e.location||n.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:n.error,location:n.location,revalidation:e.revalidation||n.revalidation}}componentDidCatch(e,n){console.error("React Router caught the following error during render",e,n)}render(){return this.state.error!==void 0?le.createElement(br.Provider,{value:this.props.routeContext},le.createElement(Sv.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function My(t){let{routeContext:e,match:n,children:i}=t,r=le.useContext(tf);return r&&r.static&&r.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=n.route.id),le.createElement(br.Provider,{value:e},i)}function Ty(t,e,n,i){var r;if(e===void 0&&(e=[]),n===void 0&&(n=null),i===void 0&&(i=null),t==null){var s;if(!n)return null;if(n.errors)t=n.matches;else if((s=i)!=null&&s.v7_partialHydration&&e.length===0&&!n.initialized&&n.matches.length>0)t=n.matches;else return null}let a=t,o=(r=n)==null?void 0:r.errors;if(o!=null){let f=a.findIndex(h=>h.route.id&&(o==null?void 0:o[h.route.id])!==void 0);f>=0||_t(!1),a=a.slice(0,Math.min(a.length,f+1))}let c=!1,u=-1;if(n&&i&&i.v7_partialHydration)for(let f=0;f<a.length;f++){let h=a[f];if((h.route.HydrateFallback||h.route.hydrateFallbackElement)&&(u=f),h.route.id){let{loaderData:p,errors:_}=n,y=h.route.loader&&p[h.route.id]===void 0&&(!_||_[h.route.id]===void 0);if(h.route.lazy||y){c=!0,u>=0?a=a.slice(0,u+1):a=[a[0]];break}}}return a.reduceRight((f,h,p)=>{let _,y=!1,x=null,m=null;n&&(_=o&&h.route.id?o[h.route.id]:void 0,x=h.route.errorElement||Sy,c&&(u<0&&p===0?(by("route-fallback"),y=!0,m=null):u===p&&(y=!0,m=h.route.hydrateFallbackElement||null)));let d=e.concat(a.slice(0,p+1)),g=()=>{let v;return _?v=x:y?v=m:h.route.Component?v=le.createElement(h.route.Component,null):h.route.element?v=h.route.element:v=f,le.createElement(My,{match:h,routeContext:{outlet:f,matches:d,isDataRoute:n!=null},children:v})};return n&&(h.route.ErrorBoundary||h.route.errorElement||p===0)?le.createElement(Ey,{location:n.location,revalidation:n.revalidation,component:x,error:_,children:g(),routeContext:{outlet:null,matches:d,isDataRoute:!0}}):g()},null)}var Tv=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(Tv||{}),wv=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(wv||{});function wy(t){let e=le.useContext(tf);return e||_t(!1),e}function Ay(t){let e=le.useContext(py);return e||_t(!1),e}function Ny(t){let e=le.useContext(br);return e||_t(!1),e}function Av(t){let e=Ny(),n=e.matches[e.matches.length-1];return n.route.id||_t(!1),n.route.id}function Ry(){var t;let e=le.useContext(Sv),n=Ay(),i=Av();return e!==void 0?e:(t=n.errors)==null?void 0:t[i]}function Cy(){let{router:t}=wy(Tv.UseNavigateStable),e=Av(wv.UseNavigateStable),n=le.useRef(!1);return Ev(()=>{n.current=!0}),le.useCallback(function(r,s){s===void 0&&(s={}),n.current&&(typeof r=="number"?t.navigate(r):t.navigate(r,wa({fromRouteId:e},s)))},[t,e])}const Ph={};function by(t,e,n){Ph[t]||(Ph[t]=!0)}function Py(t,e){t==null||t.v7_startTransition,t==null||t.v7_relativeSplatPath}function Ti(t){_t(!1)}function Ly(t){let{basename:e="/",children:n=null,location:i,navigationType:r=Pi.Pop,navigator:s,static:a=!1,future:o}=t;Da()&&_t(!1);let c=e.replace(/^\/*/,"/"),u=le.useMemo(()=>({basename:c,navigator:s,static:a,future:wa({v7_relativeSplatPath:!1},o)}),[c,o,s,a]);typeof i=="string"&&(i=Rr(i));let{pathname:f="/",search:h="",hash:p="",state:_=null,key:y="default"}=i,x=le.useMemo(()=>{let m=ef(f,c);return m==null?null:{location:{pathname:m,search:h,hash:p,state:_,key:y},navigationType:r}},[c,f,h,p,_,y,r]);return x==null?null:le.createElement(Cr.Provider,{value:u},le.createElement(kl.Provider,{children:n,value:x}))}function Dy(t){let{children:e,location:n}=t;return _y(qu(e),n)}new Promise(()=>{});function qu(t,e){e===void 0&&(e=[]);let n=[];return le.Children.forEach(t,(i,r)=>{if(!le.isValidElement(i))return;let s=[...e,r];if(i.type===le.Fragment){n.push.apply(n,qu(i.props.children,s));return}i.type!==Ti&&_t(!1),!i.props.index||!i.props.children||_t(!1);let a={id:i.props.id||s.join("-"),caseSensitive:i.props.caseSensitive,element:i.props.element,Component:i.props.Component,index:i.props.index,path:i.props.path,loader:i.props.loader,action:i.props.action,errorElement:i.props.errorElement,ErrorBoundary:i.props.ErrorBoundary,hasErrorBoundary:i.props.ErrorBoundary!=null||i.props.errorElement!=null,shouldRevalidate:i.props.shouldRevalidate,handle:i.props.handle,lazy:i.props.lazy};i.props.children&&(a.children=qu(i.props.children,s)),n.push(a)}),n}/**
